...
export function StickyExpenseNav() {
  ...
  return (
    <Navbar className="sticky top-0 z-10 h-fit max-w-full rounded-none px-4 py-2 lg:px-8 lg:py-4 dark:bg-primary ">
      <form onSubmit={handleSubmit(data => console.log(data))} className="flex 2xl:bg-red-300 xl:bg-blue-300 md:bg-black items-center justify-between text-blue-gray-900 gap-4  xl:flex-wrap 2xl:flex-row">
