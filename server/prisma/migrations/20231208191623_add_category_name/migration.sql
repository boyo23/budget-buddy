...
INSERT INTO "new_Expense" ("categoryId", "createdAt", "date", "id", "name", "paymentMethod", "price", "quantity", "updatedAt", "userId") SELECT "categoryId", "createdAt", "date", "id", "name", "paymentMethod", "price", "quantity", "updatedAt", "userId" FROM "Expense";
DROP TABLE "Expense";
